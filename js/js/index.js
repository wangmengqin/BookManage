...
$(function() {
		...
		$("#cont").load("html/search_id.html", function() {
			...
			$("#sBookById").click(function() {
				...
				if($("#bookId").val() == '') {
					...
					$.ajax({
						url: 'http://120.79.182.135:2222/getBookById',
						type: 'post',
						data: {
							bookId: $("#bookId").val()
						},
						...
						success: function(data) {
							...
							$(".edit").click(function(){
								...
								$(".certain_edit").click(function() {
									$.ajax({
										url: 'http://120.79.182.135:2222/editSearchBook',
										type: 'post',
										dataType: 'json',
										data: {
							...
							$(".del").click(function(){
								...
								var id = $(this).parent().prev().prev().prev().prev().prev().prev().prev().prev().prev().prev().html();
								$.ajax({
									url: 'http://120.79.182.135:2222/delbook',
									type: 'POST',
									dataType: 'json',
									data: {book_id: id},
									success:function(data){
		...
		$("#cont").load("html/search_byName.html", function() {
			...
			$("#sBookByName").click(function() {
				...
				if($("#search_bookName").val() == '') {
					...
					$.ajax({
						url: 'http://120.79.182.135:2222/getBookByName',
						type: 'post',
						data: {
	...
	$("#sear_byBookSort").click(function() {
		$("#cont").load("html/search_byBookSort.html", function() {
			...
			$(".book_sort_box p a").click(function() {
				...
				$.ajax({
					url: 'http://120.79.182.135:2222/getBookBySort',
					type: 'post',
					data: {
						bookSort: $(this).html()
					},
	...
	$("#pass").click(function() {
		$("#cont").load("html/pass_change.html",function(){
			...
			$(".pass_box").click(function(){
				$.ajax({
					url:"http://120.79.182.135:2222/change_pass",
					type:"post",
					data:{
						manager_id:Num,
	...
	$("#checkStatus").click(function(){
		$("#cont").load("html/check_borrowStatus.html",function(){
			//先获取所有的借阅记录
			$.ajax({
				url: 'http://120.79.182.135:2222/getAllBorrow',
				type: 'GET',
				dataType: 'json',
				success:function(data){
					console.log(data);
					...
					$(".editStatus").click(function(){
						...
						//请求后台，后台对状态进行改变
						$.ajax({
							url: 'http://120.79.182.135:2222/checkStatus',
							type: 'post',
							dataType: 'json',
							data: {
								status: s,
				...
				success:function(data){
					...
					$(".editStatus").click(function(){
						...
						$(".certain").click(function(){
							...
							$.ajax({
								url: 'http://120.79.182.135:2222/changeBoorrowTime',
								type: 'post',
								dataType: 'json',
								data: {
	...
	$("#addbook").click(function(){
		$("#cont").load("html/AddBook.html",function(){
			...
			$(".add_box").click(function(){
				$.ajax({
					url:'http://120.79.182.135:2222/addbook',
					type:'post',
					data:{
	...
	$("#addstu").click(function(){
		$("#cont").load("html/AddStu.html",function(){
			$(".add_box").click(function(){
				$.ajax({
					url:'http://120.79.182.135:2222/addstu',
					type:'post',
					data:{
	...
	$("#deletebook").click(function(){
		$("#cont").load("html/DeleteBook.html",function(){
			...
			$.ajax({
				type:"post",
				url:"http://120.79.182.135:2222/showbook",
				dataType:"json",
				success:function(data){
					var str='';
					for(var i in data){
	...
	$("#deletestu").click(function(){
		$("#cont").load("html/DeleteUser.html",function(){
			...
			$.ajax({
				type:"post",
				url:"http://120.79.182.135:2222/showstu",
				dataType:"json",
				success:function(data){
					var str='';
					for(var i in data){
					...
					$("#delbtn span").each(function(){						
						$(this).click(function(){
							$.ajax({
								url:"http://120.79.182.135:2222/delstu",
								type:"post",
								data:{
	...
	$("#authorSearch").click(function() {
		$("#cont").load("html/search_author.html", function() {
			...
			btn.click(function() {
				...
				$.ajax({
					type: "get",
					url: "http://120.79.182.135:2222/author",
					async: true,
					data: {
						author: val
					},
	...
	$("#stuSearch").click(function() {
		$("#cont").load("html/stu_search.html", function() {
			...
			$.ajax({
				type: "get",
				url: "http://120.79.182.135:2222/stu",
				async: true,
				success: function(data) {
					data = JSON.parse(data);
					for(var i in data) {
	...
	$("#loanSearch").click(function() {
		$("#cont").load("html/loaningRecord.html", function() {
			$.ajax({
				type: "get",
				url: "http://120.79.182.135:2222/loan",
				async: true,
				success: function(data) {
					data = JSON.parse(data);
					var str = `
					...
					function getStuMess(stu_id){
						$.ajax({
							type:"get",
							url:"http://120.79.182.135:2222/loan_stu",
							data:{
								id:stu_id
							},
							async:true,
					...
					function getBookMess(book_id){
						$.ajax({
							type:"get",
							url:"http://120.79.182.135:2222/loan_book",
							data:{
								id:book_id
							},
							async:true,
	...
	$("#pena").click(function() {
		$("#cont").load("html/penalty.html", function() {
			$.ajax({
				type: "get",
				url: "http://120.79.182.135:2222/pena",
				async: true,
				success: function(data) {
					data = JSON.parse(data);
					var str1 = '';
					...
					function returnFine(tr){
						...
						if(return_time.length != 0){
							...
							$.ajax({
								type: "get",
								url: "http://120.79.182.135:2222/pena_pay",
								async: true,
								data: {
									id: id
								}
